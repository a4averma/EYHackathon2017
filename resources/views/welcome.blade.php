...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <nav class="navbar sticky-top navbar-dark bg-primary justify-content-around">
            ...
            <a href="/refresh" class="btn btn-sm btn-outline-light my-2">Refresh</a>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                @endif
                @foreach($laws as $law)
                    <h1 class="display-8">{{ $law->title }} @if($law->has_seen == 0)<span class="badge badge-danger"> New</span>@endif</h1>
                    <a href="#" class="badge badge-dark">{{$law->date}}</a>
                    <span class="badge badge-info">{{$law->country}}</span>
                    <p class="lead"><?=str_replace('\r\n', '', $law->summarize)?></p>
                    <a href="document/{{$law->id}}" class="btn btn-primary">More</a>
                    <br>
                    <br>
                    <br>
                    <br>
